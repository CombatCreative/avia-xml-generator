 ...
 * {Category-ID} => array(
        ...
        'xml_nodes' => array(
                       ...
                       Use {title} to insert the post title and {date} to insert the date of the latest post in the category.
                       ...
                       You can also set a fallback value for the post meta field - if a field with the post meta key can't be found the text after the fallback separator ||| will be used. You can use %date% and %title% to insert the post publishing date or the post title
...
$avia_xml_config = array(
    54 => array(
        ...
        'xml_nodes' => array(
            'version' => '{postmeta_version|||the date: %date%}',
            'description' => 'Testdescription. {postmeta_testadd|||the date: %date%}',
            'message' => '{postmeta_testadd|||the date: %date%} {postmeta_test2|||%title%} click here for more informations!'
        )
    )
